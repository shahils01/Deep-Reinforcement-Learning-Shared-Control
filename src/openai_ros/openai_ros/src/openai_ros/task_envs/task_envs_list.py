...
def RegisterOpenAI_Ros_Env(task_env, timestep_limit_per_episode=10000):
    ...
    # Husarion Robot
    ...
    elif task_env == 'MyTurtleBot2HumanModel-v0':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.turtlebot2.turtlebot2_goal_continuous_human_model_shared:TurtleBot2HumanModelEnv',
            max_episode_steps=timestep_limit_per_episode,
        )
        # import our training environment
        from openai_ros.task_envs.turtlebot2 import turtlebot2_goal_continuous_human_model_shared

    elif task_env == 'MyTurtleBot2HumanModel-v1':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.turtlebot2.turtlebot2_goal_continuous_human_model_shared_v1:TurtleBot2HumanModelEnv',
            max_episode_steps=timestep_limit_per_episode,
        )
        # import our training environment
        ...
        register(
            id=task_env,
            entry_point='openai_ros.task_envs.turtlebot2.real_turtlebot_env:RealTurtleBot2Env',
            max_episode_steps=timestep_limit_per_episode,
        )
        # import our training environment
        from openai_ros.task_envs.turtlebot2 import real_turtlebot_env

    elif task_env == 'MyTurtleBot2Goal-v0':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.turtlebot2.turtlebot2_goal:TurtleBot2GoalEnv',
            max_episode_steps=timestep_limit_per_episode,
        )
        # import our training environment
        from openai_ros.task_envs.turtlebot2 import turtlebot2_goal
